...
#LONG_X=0.2                   # stretch x extent of box by given factor
#LONG_Y=0.2                    # stretch y extent of box by given factor
LONG_Z=2                   # stretch z extent of box by given factor
#REFLECTIVE_X=2 #=2            # X Boundary; 1: Reflective, 2: Inflow/Outflow; not active: periodic
#REFLECTIVE_Y=2 #=2            # Y Boundary; 1: Reflective, 2: Inflow/Outflow; not active: periodic
#REFLECTIVE_Z=2 #=2            # Z Boundary; 1: Reflective, 2: Inflow/Outflow; not active: periodic
